 ...
 * 查询方法对齐 DATABASE_DESIGN §8 索引：uk_daily_plan_user_date (user_id, date)
 * （PR #19 Review 改进，Migration V20260730_004 由 idx 升级为 uk，部分唯一索引 WHERE deleted_time IS NULL）。
 * <p>
...
public interface DailyPlanRepository extends JpaRepository<DailyPlan, Long> {
    ...
    /** 按用户 + 日期查询计划（登录后取今日计划，§8 uk_daily_plan_user_date 唯一索引）。 */
    ...
    /**
     * 是否已存在某日计划（业务唯一性校验，Application Service 第一道防线，
